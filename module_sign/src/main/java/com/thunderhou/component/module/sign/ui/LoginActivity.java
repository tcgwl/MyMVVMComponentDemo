package com.thunderhou.component.module.sign.ui;
...
import com.thunderhou.component.module.sign.BR;
import com.thunderhou.component.module.sign.R;
import com.thunderhou.component.module.sign.databinding.SignActivityLoginBinding;
...
public class LoginActivity extends BaseActivity<SignActivityLoginBinding, LoginViewModel> {
    ...
    public void initViewObservable() {
        // 监听ViewModel中pSwitchEvent的变化
        // 当ViewModel中执行【uc.pSwitchEvent.set(!uc.pSwitchEvent.get());】时会回调该方法
        viewModel.uc.pSwitchEvent.observe(this, new Observer<Boolean>() {
            @Override
            public void onChanged(@Nullable Boolean aBoolean) {
                //pSwitchEvent是Boolean类型的观察者,所以可以直接使用它的值改变密码开关的图标
