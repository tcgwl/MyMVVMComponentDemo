package com.thunderhou.component.module.wechat.ui.viewmodel;
...
import com.thunderhou.component.module.wechat.ui.adapter.ViewPagerBindingAdapter;
...
public class WechatViewModel extends BaseViewModel {
    ...
    public ItemBinding<ViewPagerItemViewModel> itemBinding = ItemBinding.of(BR.viewModel, R.layout.wechat_item_viewpager);
    ...
    //给ViewPager添加Adapter，请使用自定义的Adapter继承BindingViewPagerAdapter，重写onBindBinding方法
